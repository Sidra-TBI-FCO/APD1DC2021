...
gene.count = read.csv("data1/GRCh37ERCC_refseq105_genes_count.csv") # raw gene count data
#gene.count = read.csv("/data1/GRCh37ERCC_refseq105_genes_count.csv")
load("data1/geneInfo.July2017.RData") # Load geneInfo file
...
save(normalized.log2.count, file = paste0("data1/revised_normalized-log2-count.RData"))
